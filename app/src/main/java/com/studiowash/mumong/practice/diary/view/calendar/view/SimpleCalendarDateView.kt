...
import com.studiowash.mumong.databinding.ItemSimpleCalendarDateBinding
...
class SimpleCalendarDateView @JvmOverloads constructor(
    ...
    private val binding = ItemSimpleCalendarDateBinding.inflate(LayoutInflater.from(context), this, true)
